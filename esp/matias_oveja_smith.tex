...
\address{Santa Rosa 5174, Dept. 3, CABA, Argentina}
...
\position{Linux, NodeJS, ReactJS} % Your expertise/fields
%\quote{``Make the change that you want to see in the world."} % A quote or statement

\makecvfooter{Compilado \today}{Matías Oveja Smith}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
